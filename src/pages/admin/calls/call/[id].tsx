    ...
    <Layout headerTitle={
      ...
      <div className='w-full h-[90vh] flex gap-2'>
        <div className='w-1/3 h-full flex flex-col gap-2'>
          <div className='w-full h-fit max-h-[50%] p-4 rounded-md bg-foreground flex flex-col gap-2'>
            ...
            <div className='w-full h-full flex flex-col gap-2'>
              ...
              <div className='w-full h-full flex flex-col gap-2'>
                <div className='flex items-center gap-2'>
                  ...
                  <div className='w-full flex flex-col bg-sky-700/30 p-1 px-2 rounded-md'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <div className='w-full flex flex-col bg-green-700/30 p-1 px-2 rounded-md'>
                    <div className='w-full flex justify-center items-center gap-2'>
                      <Phone className='w-4 ' />
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <div className='w-full flex flex-col bg-indigo-700/30 p-1 px-2 rounded-md'>
                    <div className='w-full flex justify-center items-center gap-2'>
                      <Pause className='w-4 ' />
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <div className='w-full flex flex-col bg-purple-700/30 p-1 px-2 rounded-md'>
                    <div className='w-full flex justify-center items-center gap-2'>
                      <Play className='w-4 ' />
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <div className='w-full flex flex-col bg-red-700/30 p-1 px-2 rounded-md'>
          ...
          <div className='w-full h-fit max-h-[50%] p-4 rounded-md bg-foreground flex flex-col gap-2'>
            <div className='w-full border-b border-b-border pb-2'>
              ...
              <div className="flex items-center gap-1">
                ...
                <h1 className="font-semibold text-sm text-textAlt">Notes</h1>
              </div>
              <div>
              ...
              <div className='w-full h-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2'>
                {
                  Array.from({ length: 10 }, (_, i) => (
                    <div key={i} className='w-full h-full rounded-md flex flex-col gap-2 bg-black'>
