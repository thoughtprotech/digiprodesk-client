      ...
      <table className="bg-background w-full">
        <thead className="bg-foreground">
          <tr>
            ...
            <th className="py-2 px-4 text-left border-b border-b-border">Held Call Duration</th>
            <th className="py-2 px-4 text-left border-b border-b-border">Wait Time Duration</th>
            <th className="py-2 px-4 text-left border-b border-b-border">Transferred Calls</th>
