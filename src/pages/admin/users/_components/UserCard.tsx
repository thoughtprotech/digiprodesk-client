...
export default function UserCard({ user }: {
  ...
  return (
    <div className="h-full w-full mx-auto p-2 bg-foreground hover:bg-highlight duration-300 rounded-md border border-border flex justify-between items-center">
