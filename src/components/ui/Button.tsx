...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      className={className ? className : `w-full ${selectedColor.base} border-2 rounded-md px-2 py-1 flex items-center justify-center space-x-1 duration-300 cursor-pointer`}
      onClick={onClick}
      type={type}
    >
